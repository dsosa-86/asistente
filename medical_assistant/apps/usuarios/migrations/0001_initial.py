    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('paciente', 'Paciente'), ('medico', 'Médico'), ('administrativo', 'Administrativo')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_gestion', models.CharField(choices=[('MEDICO', 'Gestión para Médico'), ('CENTRO', 'Gestión para Centro Médico')], max_length=20)),
