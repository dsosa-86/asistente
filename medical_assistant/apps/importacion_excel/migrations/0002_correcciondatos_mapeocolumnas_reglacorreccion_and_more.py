...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='excelimport',
            options={'ordering': ['-fecha_subida'], 'verbose_name': 'Importación de Excel', 'verbose_name_plural': 'Importaciones de Excel'},
        ),
        migrations.AddField(
            model_name='excelimport',
            name='datos_corregidos',
            field=models.JSONField(blank=True, help_text='Datos después de las correcciones', null=True),
        ),
        migrations.AddField(
            model_name='excelimport',
            name='datos_originales',
            field=models.JSONField(blank=True, help_text='Datos originales del Excel', null=True),
        ),
        migrations.AddField(
            model_name='excelimport',
            name='estado',
            field=models.CharField(choices=[('PENDIENTE', 'Pendiente de Revisión'), ('EN_REVISION', 'En Revisión'), ('CORREGIDO', 'Datos Corregidos'), ('IMPORTADO', 'Importado'), ('ERROR', 'Error en Importación')], default='PENDIENTE', max_length=20),
        ),
        migrations.AddField(
            model_name='excelimport',
        ...
        migrations.AddField(
            ...
            field=models.JSONField(blank=True, help_text='Registro detallado del proceso de importación', null=True),
        ),
        migrations.AddField(
            model_name='excelimport',
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('AGENDA', 'Importación de Agenda'), ('HISTORICOS', 'Datos Históricos')], default='HISTORICOS', help_text='Tipo de datos que contiene el archivo', max_length=20),
        ),
    ]
